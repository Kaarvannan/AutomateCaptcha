...
//	driverInstance = threadLocalDriver.get();
		if (driverInstance == null) {
			// Get browser type from configuration (e.g., from properties file)
			String browser =System.getProperty("browser", "chrome") ; // Replace with logic to read browser from configuration
...
//			this.getScenario(scenario);
	...
	public void pressEnter() {
		...
		Actions action = new Actions(this.driverInstance);
